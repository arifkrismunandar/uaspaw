...
<html lang="en">
  <head>
    <title>Vendor Registration - MalilStuff</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">User Registration</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Create Your Vendor Account</h2>
          </div>
          <div class="col-md-7">

             <form action="vendor-register-proses.php" enctype="multipart/form-data" class="form-horizontal" method="post"> 
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Vendor Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_fname" name="vendorname" required autofocus />
                  </div>
                  <div class="col-md-6">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <p>Have vendor account? <a href="user-login.php">Log me in</a></p>
                  </div>
                </div>
              </div>
            </form>
