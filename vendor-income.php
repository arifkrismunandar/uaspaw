...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
       <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a href="vendor-profile.php">Profile</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Vendor Income Report</strong></div>
        </div>
      </div>
    </div>  
        ...
        <div class="row">
          <div class="col-md-5 ml-auto">
  	        <div class="p-4 border mb-3">
                ...
                <center><img class="img img-responsive rounded-circle mb-3" width="200" src="vendor/<?php echo $_SESSION['vendor']['image'] ?>" /></center>
                  ...
                  <button type="button" class="btn btn-info"><a href="vendor-profile.php"><font color="white">Profile</font></a></button>
          ...
          <div class="col-md-7">
            <div class="p-3 p-lg-5 border">
              <h4>Your Income Report From Transactions</h4>
              <div class="p-3 p-lg-5 border"> 
              ...
              ?> 
                ...
                <div class="form-group row">
                  ...
                  <?php
                    ...
                    $result = mysqli_query($link, "select * from transactions where vendor_id like '%".$vendor_id."%' order by dt desc");
                  ...
                  <h4>Transaction Value for MalilStuff</h4>
                  <div class="p-3 p-lg-5 border"> 
