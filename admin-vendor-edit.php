...
if(move_uploaded_file($tmp, 'vendor/'.$image_name)){
    ...
    if($saved)
    header("Location: admin-vendor.php?message=success-update");
  }
}
}
...
<html lang="en">
  <head>
    <title>Vendor Edit - MalilStuff</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a><span class="mx-2 mb-0"> / </span><a href="admin-page.php">Admin Page</a><span class="mx-2 mb-0"> / </span> <strong class="text-black">Vendor Edit</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Edit Vendor Account</h2>
          </div>
          <div class="col-md-7">
             ...
             <?php 
                    ...
                    $result = mysqli_query($link, "select * from vendors where id='$id'");
...
<form action="" enctype="multipart/form-data" class="form-horizontal" method="post"> 
              ...
              <div class="p-3 p-lg-5 border">
                  ...
                  <div class="col-md-6">
                    <center>
                    <br>
                		<img class="img img-responsive rounded-circle mb-3" width="180" src="vendor/<?php echo $row['image'] ?>" />
                    </center>
              	  </div>
                  <div class="col-md-6">
                    <p><font size=4>Hi admin you can edit account of vendor <?php echo $row['vendorname'] ?>, hope are comfortable with Malilstuff. In this menu you can update vendor profile.</font>
                    <br><br>
                    Phone : 0<?php echo $row['phone'] ?>
                    <br>
                    City &nbsp&nbsp;&nbsp&nbsp;: <?php echo $row['city'] ?>
                    </p>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <label for="c_fname" class="text-black">&nbsp;</label>
                    <input type="text" class="form-control" id="c_fname" name="vendorname" required="required" value="<?php echo  $row["vendorname"] ?>" />
                  </div>
                </div>    
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">City : <?php echo  $row["city"] ?></label>
                    <input type="text" class="form-control" id="c_fname" name="city" value="<?php echo  $row["city"] ?>" required="required"/>
                  </div>
                  <div class="col-md-6">
                  <label for="c_fname" class="text-black">Phone : 0<?php echo $row["phone"] ?></label>
                    <input type="text" class="form-control" id="c_fname" name="phone" value="<?php echo  $row["phone"] ?>" required="required"/>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="c_fname" name="username" required="required" value="<?php echo  $row["username"] ?>" />
                  </div>
                <div class="col-md-6">
                    <label for="c_fname" class="text-black">Email <span class="text-danger">*</span></label>
                     <input type="text" class="form-control" id="c_fname" name="email" required="required" value="<?php echo  $row["email"] ?>" />
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" name="edit" value="Save">
                      ...
                      <?php } ?>
                  <div class="col-md-6">
                    <p>Back to data list? <a href="admin-vendor.php">Let is see</a></p>
                  </div>
                  <div class="col-md-6">
                  </div>
                </div>
