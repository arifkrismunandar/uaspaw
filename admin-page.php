...
<html lang="en">
  <head>
    <title>Admin Page - MalilStuff</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Admin Page</strong></div>
        </div>
      </div>
    </div>  
          ...
          <div class="col-md-5 ml-auto">
            ...
            <div class="card-body text-center">
                  ...
                  <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                    <button type="button" class="btn btn-info"><a href="admin-setting.php?id=<?php echo $_SESSION['admin']['id']; ?>"><font color="white">Setting</font></a></button>
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <?php 
                  if (!empty($_GET['message']) && $_GET['message'] == 'success') {
                    echo '<div class="alert alert-success">Product upload successfuly.</div>';
                  }
              ...
              ?> 
                ...
                <div class="p-3 p-lg-5 border"> 
                  <div class="form-group row">
                    <div class="col-md-6">
                      <a href="admin-user.php" class="btn btn-info btn-sm btn-block" >User List</a>
                    </div>
                    <div class="col-md-6">
                      <a href="admin-vendor.php" class="btn btn-info btn-sm btn-block" >Vendor List</a>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-12">
                      <a href="admin-product.php" class="btn btn-info btn-sm btn-block" >Product List</a>
                    </div>
                </div>
                  <div class="form-group row">
                    <div class="col-md-12">
