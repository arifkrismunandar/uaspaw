  ...
  <div class="site-wrap">
    ...
    <?php 
        ...
        if(isset($_POST['deall'])){
            ...
            $result = mysqli_query($link, "select * from product where id like '%".$id."%'");
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                ...
                <h2 class="display-3 text-black">From <?php echo $row["vendorname"]; ?></h2>
                <p class="lead mb-5">From trusted cosmetic vendors.</p>
                <a href="product-buy-deal-third.php?id=<?php echo $row["id"];?>"><button type="button" class="btn btn-sm btn-info"><font color="#FFFFFF">I believe it</font></button></a>
              </div>
            </div>
          </div>
        </div>
