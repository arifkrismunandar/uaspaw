...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a href="user-profile.php">Profile</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Product Buy</strong></div>
        </div>
      </div>
    </div>  
    ...
    <?php 
        ...
        if(isset($_POST['deal'])){
            ...
            $result = mysqli_query($link, "select * from transactions where user_id like '%".$user_id."%' order by dt DESC limit 1");
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <span class="icon-circle display-3 text-warning"></span>
                <h2 class="display-3 text-black"><?php echo $row["productname"]; ?></h2>
                <p class="lead mb-5">Products that are suitable for your skin type.</p>
                <form action="product-buy-deal-second.php" method="post">
                  <input type="hidden" name="id" class="form-control py-4" value="<?php echo $row["product_id"]; ?>" >
                  <input type="submit" class="btn btn-sm btn-success" name="deall" value="It's mine">
                </form>
              </div>
            </div>
          </div>
