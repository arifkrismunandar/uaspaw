...
<html lang="en">
  <head>
    <title>Product List - MalilStuff</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.html" class="js-logo-clone">Malilstuff</a>
              </div>
            </div>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a href="admin-page.php">Admin Page</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Product List</strong></div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-9 order-2">
              ...
              <div class="col-md-12 mb-5">
                ...
                <div class="d-flex">
                 ...
                 <div class="dropdown mr-1 ml-md-auto">
                  <a href="admin-income.php"><button type="button" class="btn btn-secondary"><font color="#000000">Income Report</font></button></a>
                  </div>
            ...
            <?php 
                  if (!empty($_GET['message']) && $_GET['message'] == 'success-delete') {
                    echo '<div class="alert alert-success" role="alert"> All done. Delete of product is successfuly.</div>';
                  }
                  else if (!empty($_GET['message']) && $_GET['message'] == 'success-update') {
                    echo '<div class="alert alert-success" role="alert"> All done. Data update of product is successfuly.</div>';
                  }
              ?> 
            <div class="row mb-5">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    ...
                    <p class="mb-0">Rp. <?php echo $row["price"]; ?>,-</p>
                    <p class="mb-0">Rp. <?php echo $row["promovalue"]; ?>,- Value</p>
                    <p class="text-primary font-weight-bold"><?php echo $row["stock"]; ?> available</p>
                    <div class="form-group row">
                      <div class="col-md-6">
                      <a href="admin-product-edit.php?id=<?php echo $row["id"];?>"><button type="button" class="btn btn-warning btn-block"><font color="#FFFFFF">Edit</font>
                        </button></a>
                      </div>
                      <div class="col-md-6">
                      <a href="admin-product-delete.php?id=<?php echo $row["id"];?>" onclick="return confirm('Are you sure? Want to delete product')"><button type="button" class="btn btn-danger btn-block"><font color="#FFFFFF">Delete</font>
                        </button></a>
                      </div>
                    </div>
                  </div>
