...
if(isset($_POST['login'])){
    ...
    $sql = "SELECT * FROM vendors WHERE username=:username OR email=:email";
    $stmt = $db->prepare($sql);
    ...
    if($user){
        ...
        if(password_verify($password, $user["password"])){
            ...
            header("Location: vendor-login.php?message=error-login");
}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>Vendor Login - MalilStuff</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Vendor Login</strong></div>
        </div>
      </div>
    </div>  
          ...
          <div class="col-md-7">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <p>Create vendor account? <a href="vendor-register.php">Register</a></p>
                  </div>
                  <div class="col-md-6">
                  <br>
                    <p>Login as User? <a href="User-login.php">Try</a></p>
                  </div>
                </div>
              </div>
            </form>
