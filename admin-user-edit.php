...
if(move_uploaded_file($tmp, 'user/'.$image_name)){
    ...
    if($saved) header("Location: admin-user.php");
    header("Location: admin-user.php?message=success-update");
}
}
}
...
<html lang="en">
  <head>
    <title>User Edit - MalilStuff</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a><span class="mx-2 mb-0"> / </span><a href="admin-page.php">Admin Page</a><span class="mx-2 mb-0"> / </span> <strong class="text-black">User Edit</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Edit User Account</h2>
          </div>
          <div class="col-md-7">
            ...
            <form action="" enctype="multipart/form-data" class="form-horizontal" method="post"> 
              ...
              <div class="p-3 p-lg-5 border">
                  ...
                  <div class="col-md-6">
                    <center>
                    <br>
                		<img class="img img-responsive rounded-circle mb-3" width="180" src="user/<?php echo $row['image']; ?>" />
                    </center>
              	  </div>
                  <div class="col-md-6">
                    <p><font size=4>Hi admin edit this user is <?php echo $row['fullname'] ?>, hope she/he comfortable with Malilstuff. In this menu you can update her/him profile.</font>
                    <br><br>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="c_fname" name="fullname" required="required" value="<?php echo  $row["fullname"] ?>" />
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_fname" class="text-black">Gender : <?php echo $row["gender"] ?></label>
                 ...
                 <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="c_fname" name="city" placeholder="Your City" value="<?php echo  $row["city"] ?>" required="required"/>
                  </div>
                  <div class="col-md-6">
                  <label for="c_fname" class="text-black">Phone : 0<?php echo $row["phone"] ?></label>
                    <input type="text" class="form-control" id="c_fname" name="phone" required="required" value="<?php echo  $row["phone"] ?>" placeholder="New phone number" />
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" name="edit" value="Save">
                      ...
                      <?php } ?>
                  <div class="col-md-6">
                    <p>Back to data list? <a href="admin-user.php">Let is see</a></p>
                  </div>
                </div>
              </div>
            </form>
