...
<html lang="en">
  <head>
    <title>User Profile - MalilStuff</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">User Profile</strong></div>
        </div>
      </div>
    </div>  
              ...
              <div class="card-body text-center">
                <center><img class="img img-responsive rounded-circle mb-3" width="200" src="user/<?php echo $_SESSION['user']['image'] ?>" /></center>
                  ...
                  <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                    <button type="button" class="btn btn-info"><a href="user-setting.php?id=<?php echo $_SESSION['user']['id']; ?>"><font color="white">Setting</font></a></button>
          ...
          <div class="col-md-7">
            <div class="p-3 p-lg-5 border">
              <div class="form-group row">
                <div class="col-md-6">
                  <a href="featur-skin-detection.php"><button type="submit" class="btn btn-sm btn-warning btn-lg btn-block"><font color="#FFFFFF">Checkup Your Skin</font></button></a>
                </div>
                <div class="col-md-6">
                  <form action="featur-skin-detection-result.php" method="post">
                    <input type="hidden" name="user_id" class="form-control py-4" value="<?php echo $_SESSION['user']['id']; ?>" placeholder="<?php echo $_SESSION['vendor']['id']; ?>">
                  ...
                  <?php 
                    if (!empty($_GET['message']) && $_GET['message'] == 'success') {
                      echo '<div class="alert alert-success">Testimonials sent successfully.</div>';
                    }
                    else if (!empty($_GET['message']) && $_GET['message'] == 'failed') {
                      echo '<div class="alert alert-danger">Testimonials failed send.</div>';
                    }
                  ?> 
               ...
               <form action="featur-status.php" method="post" />
                <input type="hidden" name="fullname" value="<?php echo $_SESSION['user']['fullname']; ?>">
                  <div class="form-group">
                      <textarea class="form-control" name="testi" placeholder="What do you think?"></textarea>
                      <input type="submit" name="status" class="btn btn-sm btn-primary btn-lg btn-block" value="Send">
                  </div>
                 </form>
                </div>
              </div>
