          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                ...
                <h2 class="display-3 text-black">For your <?php echo $row["efficacy"]; ?> skin type</h2>
                <p class="lead mb-5">This is a good solution for you.</p>
                <form action="product-buy-deal-proses.php" method="post">
                        <input type="hidden" name="id" value="<?php echo $row["id"]; ?>">
                        <input type="hidden" name="stock" value="<?php echo $row["stock"] - 1; ?>">
                        <input type="submit" class="btn btn-sm btn-success" name="deal" value="Deal to this">
                </form>
              </div>
            </div>
          </div>
