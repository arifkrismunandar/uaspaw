...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a href="admin-page.php">Admnin Page</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Product Edit</strong></div>
        </div>  
      </div>
    </div>  
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="p-3 p-lg-5 border">
              ...
              <form action="admin-product-update.php" enctype="multipart/form-data" class="form-horizontal" method="post">
              ...
              <hr>
                ...
                <div class="p-3 p-lg-5 border"> 
                  <div class="form-group row">
                  <div class="col-md-12">
                    <a href="admin-income.php" class="btn btn-info btn-sm btn-block" >view income report</a>
                  </div>
                </div>
              </div>
            </div>
