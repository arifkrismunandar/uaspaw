                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-md-12 text-center">
                        ...
                        <p><a href="user-profile.php" class="btn btn-sm btn-primary">Back to profile</a></p>
                      </div>
                    </div>
                  </div>
                </div>';
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-md-12 text-center">
                      ...
                      <h2 class="display-3 text-black">Ups sorry!</h2>
                      <p class="lead mb-5">You order was failed. Product stock is empty.</p>
                      <p><a href="user-profile.php" class="btn btn-sm btn-primary">Back to profile</a></p>
                    </div>
                  </div>
                </div>
