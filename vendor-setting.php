...
if(move_uploaded_file($tmp, 'vendor/'.$image_name)){
    // menyiapkan query
    $sql = "UPDATE vendors SET image='$image_name', vendorname='$vendorname', username='$username', city='$city', phone='$phone', email='$email', password='$password' WHERE id='$id' ";
    $stmt = $db->prepare($sql);
    ...
    if($saved)
    header("Location: vendor-login.php?message=success-update");
  }
}
}
?>
...
<html lang="en">
  <head>
    <title>Vendor Setting - MalilStuff</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a href="vendor-profile.php">Profile</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Vendor Setting</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Setting Your Vendor Account</h2>
          </div>
          <div class="col-md-7">

            <form action="" enctype="multipart/form-data" class="form-horizontal" method="post"> 
              <input type="hidden" name="id" value="<?php echo $_SESSION["vendor"]["id"] ?>" />
              <div class="p-3 p-lg-5 border">
              	<div class="form-group row">
                  <div class="col-md-6">
                    <center>
                    <br>
                		<img class="img img-responsive rounded-circle mb-3" width="180" src="vendor/<?php echo $_SESSION['vendor']['image'] ?>" />
                    </center>
              	  </div>
                  <div class="col-md-6">
                    <p><font size=4>Hi <?php echo $_SESSION['vendor']['vendorname'] ?> is happy to know you, hope you are comfortable with Malilstuff. In this menu you can update your profile.</font>
                    <br><br>
                    Phone : 0<?php echo $_SESSION['vendor']['phone'] ?>
                    <br>
                    City &nbsp&nbsp;&nbsp&nbsp;: <?php echo $_SESSION['vendor']['city'] ?>
                    </p>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input type="file" name="image" class="form-control" value="<?php echo  $_SESSION["vendor"]["image"] ?>" required autofocus />
                  </div>
                  <div class="col-md-6">
                  <label for="c_fname" class="text-black">&nbsp;</label>
                    <input type="text" class="form-control" id="c_fname" name="vendorname" required="required" value="<?php echo  $_SESSION["vendor"]["vendorname"] ?>" />
                  </div>
                </div>    
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">City : <?php echo  $_SESSION["vendor"]["city"] ?></label>
                    <input type="text" class="form-control" id="c_fname" name="city" value="<?php echo  $_SESSION["vendor"]["city"] ?>" required="required"/>
                  </div>
                  <div class="col-md-6">
                  <label for="c_fname" class="text-black">Phone : 0<?php echo $_SESSION["vendor"]["phone"] ?></label>
                    <input type="text" class="form-control" id="c_fname" name="phone" value="<?php echo  $_SESSION["vendor"]["phone"] ?>" required="required"/>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="c_fname" name="username" required="required" value="<?php echo  $_SESSION["vendor"]["username"] ?>" />
                  </div>
                <div class="col-md-6">
                    <label for="c_fname" class="text-black">Email <span class="text-danger">*</span></label>
                     <input type="text" class="form-control" id="c_fname" name="email" required="required" value="<?php echo  $_SESSION["vendor"]["email"] ?>" />
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-6">
                    <p>Back to Vendor profile? <a href="vendor-profile.php?id=<?php echo $_SESSION["vendor"]["id"] ?>">Let is see</a></p>
                  </div>
                  <div class="col-md-6">
                  <br>
                     <p>Delete account?<a href="vendor-delete.php?id=<?php echo $_SESSION["vendor"]["id"] ?>" onclick="return confirm('Are you sure? Want to delete account')"><span class="text-danger"> Want to delete</span></a>
                  </div>
                </div>
              </div>
            </form>
