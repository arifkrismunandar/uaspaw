...
<html lang="en">
  <head>
    <title>User List - MalilStuff</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a href="admin-page.php">Admin Page</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">User List</strong></div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">User List</h2></div>
                <div class="d-flex">
                 
                 <div class="dropdown mr-1 ml-md-auto">
                  <a href="admin-vendor.php"><button type="button" class="btn btn-secondary"><font color="#000000">Vendor List</font></button></a>
                  </div>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <img src="user/<?php echo $row["image"]; ?>" alt="Image" alt="Image placeholder" class="img-fluid">
                  </figure>
                  <div class="block-4-text p-4">
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                      <a href="admin-user-edit.php?id=<?php echo $row["id"];?>"><button type="button" class="btn btn-warning btn-block"><font color="#FFFFFF">Edit</font>
                        </button></a>
                      </div>
                      <div class="col-md-6">
                      <a href="admin-user-delete.php?id=<?php echo $row["id"];?>" onclick="return confirm('Are you sure? Want to delete user')"><button type="button" class="btn btn-danger btn-block"><font color="#FFFFFF">Delete</font>
                        </button></a>
                      </div>
                    </div>
                  </div>
