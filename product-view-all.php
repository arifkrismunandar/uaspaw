...
<html lang="en">
  <head>
    <title>All Product - MalilStuff</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a href="vendor-profile.php">Profile</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">All Product</strong></div>
        </div>
      </div>
    </div>
              ...
              <div class="col-md-12 mb-5">
                ...
                <div class="d-flex">
                 ...
                 <div class="dropdown mr-1 ml-md-auto">
                  <a href="product-view-all.php"><button type="button" class="btn btn-secondary"><font color="#000000">Refresh</font></button></a>
                  </div>
                  <div class="btn-group">
                   <form action="product-view.php" method="post">
                    <input type="hidden" name="vendor_id" class="form-control py-4" value="<?php echo $_SESSION['vendor']['id']; ?>" placeholder="<?php echo $_SESSION['vendor']['id']; ?>">
                      <input type="submit" class="btn btn-secondary" name="cek" value="See Your Product">
                      </form>
                      </div>
                </div>
              </div>
